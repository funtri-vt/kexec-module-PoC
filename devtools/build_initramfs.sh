...
/sbin/kexec -l /payload/bzImage \
    ...
    --command-line="console=tty0 console=$TARGET_TTY $TARGET_CONSOLE_ARG root=/dev/ram0 rw debug earlyprintk=serial,ttyS0,115200 loglevel=8 initcall_debug cros_debug cros_secure=0 reset_devices i8042.reset i8042.nomux amd_iommu=off iommu=soft noapic nolapic amdgpu.sg_display=0 amdgpu.runpm=0 amdgpu.aspm=0 nomodeset"
